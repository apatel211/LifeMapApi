...
(function() {
  ...
  MySQLRunner = (function(_super) {
    __extends(MySQLRunner, _super);
    ...
    MySQLRunner.prototype._get_options = function(additional) {
      ...
      return MySQLRunner.__super__._get_options.call(this, Util.merge(my_opts, additional));
    };
    ...
    MySQLRunner.prototype._stringify_results = function() {
      ...
      rows = arguments[0], fields = arguments[1], other = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      if (rows != null) {
        return JSON.stringify(rows, null, 2);
      } else {
        return MySQLRunner.__super__._stringify_results.apply(this, [rows, fields].concat(__slice.call(other)));
      }
    };
