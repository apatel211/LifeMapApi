...
(function() {
  ...
  SQLRunner = (function() {
    ...
    function SQLRunner(client, options) {
      ...
      this.execute_file = __bind(this.execute_file, this);
        ...
        action = (function(_this) {
          return function(stmt, index, list, next) {
            return _this.client.execute(stmt, function() {
              var err, tail;
              err = arguments[0], tail = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    ...
    SQLRunner.prototype.main = function(argv, logfn, errfn, callback) {
      var ARGF, argf, buffer, optimist, original_argv, _ref, _ref1;
      ...
      try {
        ...
        if (argv.help) {
          ...
          if (!this.client) {
            ...
            if (argv.verbose) {
              if (((_ref = argv._) != null ? _ref.length : void 0) > 0) {
                logfn("Reading from " + ((_ref1 = argv._) != null ? _ref1.length : void 0) + " input files.");
              } else {
