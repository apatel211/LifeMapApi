<html><head><style><!-- /* a stylesheet to include in our *.md-based html. */ -->
...
#TofC { font-family: 'droid sans',helvetica,sans serif; font-size: 0.8em; position: fixed; right: 0em; top: 0em; background: #e5e5ee; border-radius: 0 0 0 1em; padding-bottom: 1em; z-index: 200; max-width: 7em; white-space:nowrap; text-align: left; max-height: 60%;  padding-top: 3em; opacity: 0.8; padding-right:2em; overflow:hidden; box-shadow: 1px 1px 1px 1px rgba(51,51,51,0.5); }
#TofC:before { content:"Contents"; font-weight: bold; text-align:right; align:right; display:block; position:fixed; right: 1.5em; top: 1em; }
#TofC:hover { width: auto; max-width:40em; overflow:auto !important; opacity:1.0; background: #fcfcfc; box-shadow: 10px 6px 6px 5px rgba(51,51,51,0.7); }
#TofC ul { margin: 0 0 0 1em; padding: 0;}
#TofC > ul { border-bottom: 0.5px solid #ccc; }
#TofC li { padding: 0; margin: 1px; list-style: none; overflow:hidden; text-overflow: ellipsis; opacity: 0.8; }
#TofC:hover li { opacity: 1; }
#TofC { transition: max-width 0.2s ease, opacity 0.25s ease, background 0.3s ease, box-shadow 0.2s ease; }
#TofC li { transition: opacity 0.2s ease; }
...
pre, code, kbd, samp { font-family: 'droid sans mono slashed', 'droid sans mono', monospace, monospaced; }
pre { padding:1em; background:#333; color:#9e9; border:1px solid #444; overflow:hidden; text-overflow: ellipsis; border-radius: 1em; }
pre:hover { overflow:visible; width: auto; }
pre:hover code {  background:#333; }
code { background: #f5f5ff; font-size:0.9em; border-radius: 0.3em; border: 1px solid #D2D2D2; padding: 2px 5px; }
...
pre code { border: none; background:#333; padding: 0; }
...
<h1 id="inote-util-release-notes">inote-util Release Notes</h1>
<p>This file summarizes the changes bundled in each release of <code>inote-util</code>.</p>
<div id=TofC>

<ul>
<li><a href="#release-040-14-novemver-2014">Release 0.4.0 - 14 Novemver 2014</a><ul>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-035-2-novemver-2014">Release 0.3.5 - 2 Novemver 2014</a><ul>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-033-20-october-2014">Release 0.3.3 - 20 October 2014</a><ul>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-032-20-october-2014">Release 0.3.2 - 20 October 2014</a><ul>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-031-18-october-2014">Release 0.3.1 - 18 October 2014</a><ul>
<li><a href="#bug-fixes">Bug Fixes</a></li>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-021-15-october-2014">Release 0.2.1 - 15 October 2014</a><ul>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-020-5-october-2014">Release 0.2.0 - 5 October 2014</a><ul>
<li><a href="#bug-fixes">Bug Fixes</a></li>
<li><a href="#enhancements">Enhancements</a></li>
</ul>
</li>
<li><a href="#release-011-30-september-2014">Release 0.1.1 - 30 September 2014</a></li>
</ul>
<div style="font-size: 0.9em; text-align: right"><a href="." >[up]</a> <a href="javascript:back(-1)">[back]</a></div></div>


<h2 id="release-0-4-0-14-novemver-2014">Release 0.4.0 - 14 Novemver 2014</h2>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li>Added <code>arrays_are_equal</code>, <code>uniquify</code>, <code>object_array_to_map</code>, <code>truthy_string</code> and <code>falsey_string</code> to <code>Util</code>..</li>
</ul>
<h2 id="release-0-3-5-2-novemver-2014">Release 0.3.5 - 2 Novemver 2014</h2>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li><p>Added <code>Util.remove_falsey</code>.</p>
</li>
<li><p>Added documention.</p>
</li>
</ul>
<h2 id="release-0-3-3-20-october-2014">Release 0.3.3 - 20 October 2014</h2>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li>Enhanced <code>Util.blank_to_null</code> to convert blank object attributes to <code>null</code>.</li>
</ul>
<h2 id="release-0-3-2-20-october-2014">Release 0.3.2 - 20 October 2014</h2>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li><p>Added <code>Util.blank_to_null</code>.</p>
</li>
<li><p>Added option to <code>Util.handle_error</code> for throwing an error rather than invoking a callback.</p>
</li>
</ul>
<h2 id="release-0-3-1-18-october-2014">Release 0.3.1 - 18 October 2014</h2>
<h3 id="bug-fixes">Bug Fixes</h3>
<ul>
<li>Fixed issue with <code>Util.is_blank()</code> not testing for non-alphanumeric characters like <code>/</code> or <code>$</code>.</li>
</ul>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li>Added <code>Util.hash_password</code>, <code>Util.validate_hash_password</code> and <code>Util.slow_equals</code> methods.</li>
</ul>
<h2 id="release-0-2-1-15-october-2014">Release 0.2.1 - 15 October 2014</h2>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li>Added <code>Config</code> (<code>config.coffee</code>).</li>
</ul>
<h2 id="release-0-2-0-5-october-2014">Release 0.2.0 - 5 October 2014</h2>
<h3 id="bug-fixes">Bug Fixes</h3>
<ul>
<li>Various documentation and test updates.</li>
</ul>
<h3 id="enhancements">Enhancements</h3>
<ul>
<li><p>Added <code>timer.lap()</code> to <code>Stopwatch</code>.</p>
</li>
<li><p>Added <code>Util.escape_for_regexp</code>.</p>
</li>
<li><p>Added &quot;marker&quot; parameter to <code>Util.truncate</code>, and tweaked related logic.</p>
</li>
</ul>
<h2 id="release-0-1-1-30-september-2014">Release 0.1.1 - 30 September 2014</h2>
<ul>
<li><em>Change log not tracked up to and including this release.</em></li>
</ul>
