...
<h1 id="inote-util-documentation">inote-util documentation</h1>
<p>This directory contains the raw-source for (and, when published,
HTML rendered from) inote-util documentation and related
meta-information.</p>
<h1 id="contents">Contents</h1>
<p>Once generated, this directory should contain:</p>
<ul>
<li><p>Partial <a href="./api.html">API documentation</a> (<a href="./api.md">md</a>) (a work in progress).</p>
</li>
<li><p>Complete <a href="./docco/index.html">annotated source code</a>.</p>
</li>
<li><p>A <a href="./coverage.html">test coverage report</a>.</p>
</li>
<li><p><a href="./release-notes.html">Release notes</a> (<a href="./release-notes.md">md</a>).</p>
</li>
</ul>
<h1 id="generating">Generating</h1>
<p>You can use the <a href="../Makefile"><code>Makefile</code></a> targets to generate the
&quot;published&quot; contents of this directory.</p>
<p>Specifically</p>
<ul>
<li><p><code>make markdown</code> will generate HTML documents from various Markdown
files found in this directory (and elsewhere).</p>
</li>
<li><p><code>make docco</code> will generate an HTML rendering of the annotated
source code (using the documentation generating tool
<a href="http://jashkenas.github.io/docco/">docco</a>).</p>
</li>
<li><p><code>make coverage</code> will instrument the module&#39;s source code (using
<a href="https://github.com/benbria/coffee-coverage">coffee-coverage</a>) and
run <a href="../test">the unit test suite</a> to generate a test coverage
report.</p>
</li>
<li><p><code>make docs</code> is equivalent to <code>make markdown docco</code>, hence you can
run <code>make docs coverage</code> to generate all of the above.</p>
</li>
</ul>
