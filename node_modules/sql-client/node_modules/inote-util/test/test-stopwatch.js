...
(function() {
  ...
  describe("Stopwatch", function() {
    beforeEach(function(done) {
      this.method_started = false;
      this.method_finished = false;
      this.a_slow_method = (function(_this) {
        return function() {
          var foo, i, j, sum, _i, _j;
    ...
    it("can be used for timing \"inline\".", function(done) {
      var timer;
      ...
      this.method_started.should.be.ok;
      this.method_finished.should.be.ok;
      return done();
    });
    it("can be used to track \"lap\" times.", function(done) {
      var timer;
      timer = Stopwatch.start();
      timer.start_time.should.exist;
      should.not.exist(timer.finish_time);
    ...
    it("doesn't always give the same time.", function(done) {
      var result;
      result = [];
    ...
    it("can wrap a method in order to time it.", function(done) {
      var result;
      this.method_started.should.not.be.ok;
      this.method_finished.should.not.be.ok;
      result = Stopwatch.time(this.a_slow_method);
      this.method_started.should.be.ok;
      this.method_finished.should.be.ok;
      result.should.exist;
    ...
    return it("returns any provided data (wrapped)", function(done) {
      var result;
      this.method_started.should.not.be.ok;
      this.method_finished.should.not.be.ok;
