...
var randomnumberemp ="604960002";
//var randomnumberempdep=Math.floor(Math.random()*233434433)
var randomnumberempdep = "404940002";
var EmpNum ;
var EmpDepNum;
var authtoken;
...
describe('Lifemap api', function() {
    ...
    it('Create employee dependent coverage', function(done) {
        ...
        console.log("benefitID is " +benid);
        console.log("Employee No is " +EmpNum);
        console.log("Employee Dependent no is " +EmpDepNum);
        console.log("The authtokenandtype is : " + authtokenandtype);
        testCaseId = 1044343;
       Testurl
   ...
   it('delete employee dependent coverage', function(done) {
        ...
        testCaseId = 1044343;
        Testurl
          .delete('/groupadmin-1.0.2/api/employee/dependent/coverages/'+ UpdateCovNum)
          .set('Content-Type','application/json')
          .set('Authorization',authtokenandtype)
          .send({
